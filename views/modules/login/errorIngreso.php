<nav class="navbar navbar-light bg-white">
  <a class="navbar-brand text-Inicio" href="memorium"><span class="inicio"> <img class="rounded" src="views/bootstrap/image/favicon.ico" width="25"> Inicio </span></a>
</nav>
<div class="principal">
...
<?php endif?>
  ...
  <div class="card-block">
    <h4 class="card-title">Inicia sesión en Mermorium.</h4><br>
      <section class="head">
